...
const MapperModule = () => {
  ...
  // Modify handleFormChange to prevent spaces in certain fields
  ...
  // Modify handleRowChange to better handle primary key changes
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {/* Create Job Button */}
                  {hasBeenValidated && allRowsValidated && isActivationSuccessful && (
                    <Button
                      variant="contained"
